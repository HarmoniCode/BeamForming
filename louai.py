...
class HeatMapWindow(QMainWindow):
    def __init__(self):
        ...
        self.num_antennas = 2
        self.distance_m = 1.0  # Distance in meters
        self.delay_deg = 10.0  # Delay in degrees
        self.frequency = 1e6  # Default: 1 MHz
        self.propagation_speed = 3e8  # Default: Speed of light in m/s
    ...
    def plot_heatmap(self):
        ...
        distance_m = self.distance_spinbox.value()
        delay_deg = self.delay_spinbox.value()
        ...
        if array_geometry == "Curved":
            ...
            y_positions = -curvature * (antenna_positions ** 2)  # Change Y positions only and X positions remain the same
        else:
        ...
        # Plot heatmap with normal Y-axis (no flip)
